...
NEW: CoreScientificEngine v5 - Fully integrated central motor
     Connected to: Physics, Chemistry, Mathematics, Geometry
     Single file | Fully English | Ready for further expansion
====================================================
"""
...
class CoreScientificEngine:
    ...
    def get_molar_mass(self, formula):
        """Chemistry molar mass (uses existing function but can be expanded)"""
